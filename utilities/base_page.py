...
class BasePage():
    ...
    def wait_until_element_present(self, locator_value, timeout=constants.DRIVER_TIMEOUT):
        self.__wait_until(locator_value, expected_conditions.presence_of_element_located, timeout)

    def wait_until_element_visible(self, locator_value, timeout=constants.DRIVER_TIMEOUT):
        self.__wait_until(locator_value, expected_conditions.visibility_of_element_located, timeout)

    def wait_until_element_invisible(self, locator_value, timeout=constants.DRIVER_TIMEOUT):
